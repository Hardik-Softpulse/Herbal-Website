      ...
      <section class="blog_detail">
        <div class="container">
          <div class="spacer">
            ...
            <div class="main_blog_detail flex">
              <div class="left_blog_detail">
                <div class="left_blog_detail_img">
                  {image && (
                    <Image
                      data={image}
                      loading="eager"
                        ...
                        <li>
                          <a href="">
                            ...
                            >
                              ...
                              <g id="Blog Detail" clip-path="url(#clip0_0_1)">
                                <rect
                                  width="1920"
                                  height="4303"
                        ...
                        <li>
                          <a href="">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_220_1646)">
                                <path
                                  d="M15 29C22.732 29 29 22.732 29 15C29 7.26801 22.732 1 15 1C7.26801 1 1 7.26801 1 15C1 22.732 7.26801 29 15 29Z"
                                  stroke="#1C6758"
                                  stroke-width="0.875"
                        ...
                        <li>
                          <a href="">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_220_1650)">
                                <path
                                  d="M15 29C22.732 29 29 22.732 29 15C29 7.26801 22.732 1 15 1C7.26801 1 1 7.26801 1 15C1 22.732 7.26801 29 15 29Z"
                                  stroke="#1C6758"
                                  stroke-width="0.875"
                        ...
                        <li>
                          <a href="">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_220_1654)">
                                <path
                                  d="M15 29C22.732 29 29 22.732 29 15C29 7.26801 22.732 1 15 1C7.26801 1 1 7.26801 1 15C1 22.732 7.26801 29 15 29Z"
                                  stroke="#1C6758"
                                  stroke-width="0.875"
                        ...
                        <li>
                          <a href="">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_220_1658)">
                                <path
                        ...
                        <li>
                          <a href="">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_220_1662)">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
              ...
              <div class="right_blog_detail">
                ...
                <div class="right_blog_product">
                  ...
                  <div class="right_blog_pro_content">
                    <p>CBD+CBG OIL 20%</p>
                    <h4>Full Moon Oil Cbd 20</h4>
                    <div class="blog_pro_price flex">
                      <h5>$19.00</h5>
                      <s>$24.00</s>
                      <span>20% off</span>
                    </div>
